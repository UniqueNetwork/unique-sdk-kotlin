...
class BalanceServiceImpl(signer: Signer, basePath: String) : BalanceService {

    private val api: BalanceApi = BalanceApi(basePath)

    private val transferMutationService: MutationService<TransferBody> = TransferMutationServiceImpl(signer, basePath)
