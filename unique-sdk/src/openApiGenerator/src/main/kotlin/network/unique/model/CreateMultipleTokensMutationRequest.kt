...
import network.unique.model.CreateTokenPayload
...
data class CreateMultipleTokensMutationRequest (
    ...
    @Json(name = "tokens")
    val tokens: kotlin.collections.List<CreateTokenPayload>? = null,
