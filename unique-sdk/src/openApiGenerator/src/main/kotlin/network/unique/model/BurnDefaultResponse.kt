...
import network.unique.model.BurnFungibleParsed
import network.unique.model.BurnFungibleResponse
...
data class BurnDefaultResponse (
    ...
    @Json(name = "parsed")
    val parsed: BurnFungibleParsed? = null,
