...
class CreateRefungibleTokensMutationServiceImpl(basePath: String) : MutationService<AddTokensMutationRequest1>() {
    ...
    override fun sign(args: AddTokensMutationRequest1, seed: String): SubmitTxBody {
    ...
    override fun submit(args: AddTokensMutationRequest1, seed: String): SubmitResultResponse {
    ...
    override fun submitWatch(args: AddTokensMutationRequest1, seed: String): SubmitResultResponse {
        val signedBody = sign(args, seed)
